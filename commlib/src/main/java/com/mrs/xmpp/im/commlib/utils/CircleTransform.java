...
class CircleTransform implements Transformation<Bitmap> {

    private BitmapPool mBitmapPool;
    private int mRadius;

    public CircleTransform(Context context, int mRadius) {
        this(Glide.get(context).getBitmapPool(), mRadius);
    }

    public CircleTransform(BitmapPool mBitmapPool, int mRadius) {
    ...
    @Override
    public String getId() {
        return "CircleTransform(radius=" + mRadius + ")";
    }
}
